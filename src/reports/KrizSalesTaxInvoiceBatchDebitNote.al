report 50018 "Kriz Sales Debit Note Batch"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/KrizSalesTaxInvoiceBatchDebitNote.rdl';
    Caption = 'Frontier Debit Note Invoice (Batch Detials)';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CustomerFLNo; Customer."Cost Center")
                    {
                    }
                    ...
                    column(CompanyAddr4; Loc.City + '-' + Loc."Post Code" + ',' + cState.Description)//CompanyAddr[4])
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(No_SalesInvLine; "GL Code")
                        {
                        }
            ...
            begin
                ...
                LocationName := "Shipping from Location";
                // sandeep
                cState.Reset();
                cState.SetRange(Code, "Location Code");
                if cState.Find('-') then;
