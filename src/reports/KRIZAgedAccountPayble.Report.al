report 50030 "KrizAgedAccountPayble"
{
    ProcessingOnly = true;
    Caption = 'Aged Account Payable Excel New';
        ...
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            begin
                ...
                if vendorRecord.FindFirst() then begin
                    txtData[1] := "Vendor No.";
                    txtData[2] := vendorRecord.Name;
                    txtData[3] := vendorRecord."Search Name";
                    // txtData[4] := vendorRecord."Vendor Code";
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Vendor No', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);             //txtData[1]
        TempExcelBuffer.AddColumn('vendor Name ', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);             //txtData[2]
        TempExcelBuffer.AddColumn('Vendor Search Name', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);              //txtData[3]
