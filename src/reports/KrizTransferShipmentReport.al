report 50023 "Kriz GST-Transfer Shipment"           //Remarks = Some Fields and Tables not present error
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/KrizTransferShipmentReport.rdl';
    ApplicationArea = all;
