report 50027 "Kriz Sales Cr Inv Batch TM"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/KrizSalesReturnTaxInvoiceBatchTM.rdl';
    Caption = 'Truemart Sales Return Invoice (Batch Detials)';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            RequestFilterHeading = 'Posted Sales Cr. Memo Headers';
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(OrderNo_SalesInvoiceHdr; "Sales Cr.Memo Header"."Return Order No.")
                    {
                    }
                    ...
                    dataitem(DimensionLoop1; Integer)
                    {
                        ...
                        begin
                            HdrLoc.get("Sales Cr.Memo Header"."Location Code");
                            HdrState.Reset();
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            if "Sales Cr.Memo Line".Type = "Sales Cr.Memo Line".Type::Item then begin
                                ...
                                recItemUOM.Get("Sales Cr.Memo Line"."No.", "Sales Cr.Memo Line"."Unit of Measure Code");
                                // if Item."EDC SPQ" <> 0 then
                                //     //NoofCasesLine := ROUND("Sales Cr.Memo Line".Quantity / Item."EDC SPQ", 1, '>')
                                //     NoofCasesLine := ROUND((("Sales Cr.Memo Line".Quantity * recItemUOM."Qty. per Unit of Measure") / Item."EDC SPQ"), 1, '>')

                                // else
                                //rav   NoofCasesLine := ROUND((("Sales Cr.Memo Line".Quantity * recItemUOM."Qty. per Unit of Measure") / Item."EDC SPQ"), 1, '>')
            ...
            begin
                ...
                LocationName := "Sales Cr.Memo Header"."Location Code";
    ...
    BuyerState := RecState.Description;
                ...
                RRLRNo := "Sales Cr.Memo Header"."LR No.";
                RRLRDate := "Sales Cr.Memo Header"."LR Date";
                VehicleNo := "Sales Cr.Memo Header"."Vehicle No.";

                EWaybillNo := "Sales Cr.Memo Header"."Eway Bill No.";
                //Message();
