report 50029 "Kriz Purchase Return"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/KrizPurchaseReturnReport.rdl';
    Caption = 'Purchase Return (Batch Detials)';
    ...
    dataset
    {
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            RequestFilterHeading = 'Posted Purchase Return Invoice';
            ...
            column(Duedt; "Purch. Cr. Memo Hdr."."Due Date")
            {
            }
            column(Paytrm; "Purch. Cr. Memo Hdr."."Payment Terms Code")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfo_GST_RegistrationNo; 'GSTIN: ' + "Purch. Cr. Memo Hdr."."Location GST Reg. No.")
                    {
                    }
                    column(CustomerRegistrationLbl; CustomerRegistrationLbl)
                    {
                    }
                    column(CustomerPLNo; Vendor."No.")
                    {
                    }
                    column(CustomerPLDate; Vendor."No.")
                    {
                    }
                    column(CustomerFLNo; Vendor."No.")
                    {
                    }
                    column(CustomerFLDate; Vendor."No.")
                    {
                    }
                    column(CustomerPLNoShip; '')//ShipToAddRec.kriz)
                    {
                    }
                    column(CustomerPLDateShip; '')//ShipToAddRec."Kriz PL Validity")
                    {
                    }
                    column(CustomerFLNoShip; '')//ShipToAddRec."Kriz FL Number")
                    {
                    }
                    column(CustomerFLDateShip; '')//ShipToAddRec."Kriz FL Validity")
                    {
                    }
                    column(Customer_GST_RegistrationNo; 'GSTIN: ' + Vendor."GST Registration No.")
                    {
                    }
                    ...
                    column(CustAddr1; "Purch. Cr. Memo Hdr."."Buy-from Vendor No." + '-' + CustAddr[1])
                    {
                    }
                    ...
                    column(CompanyAddr4; CompanyInfo."Post Code" + ',' + CompanyInfo.City)//CompanyAddr[4])
                    {
                    }
                    ...
                    column(CIN; '')//'FSSAI No.: ' + CompanyInfo."KCP FSSAI No.")
                    {
                    }
                    ...
                    column(BillToContact_SalesInvHdr; Vendor."Phone No.")
                    {
                    }
                    column(OrderDate_SalesInvHdr; "Purch. Cr. Memo Hdr."."Document Date")
                    {
                    }
                    column(PLNo_Location; Loc."Kriz PL Number")
                    {
                    }
                    column(PLDate_Location; '')//Loc."Kriz PL Validity")
                    {
                    }
                    column(FLNo_Location; Loc."Kriz FL Number")
                    {
                    }
                    column(FLDate_Location; '')//Loc."Kriz FL Validity")
                    {
                    }
                    column(ShipToContact_SalesInvHdr; ShipToContactNo)
                    {
                    }
                    column(BillToCustNo_SalesInvHdr; "Purch. Cr. Memo Hdr."."Buy-from Vendor No.")
                    {
                    }
                    column(PostingDate_SalesInvHdr; Format("Purch. Cr. Memo Hdr."."Posting Date", 0, '<Day,2>-<Month,2>-<Year4>'))
                    {
                    }
                    column(VATNoText; 'PAN: ' + CompanyInfo."P.A.N. No.")
                    {
                    }
                    column(VATRegNo_SalesInvHdr; "Purch. Cr. Memo Hdr."."VAT Registration No.")
                    {
                    }
                    column(DueDate_SalesInvoiceHdr; Format("Purch. Cr. Memo Hdr."."Due Date", 0, '<Day,2>-<Month,2>-<Year4>'))
                    {
                    }
                    ...
                    column(YourReference_SalesInvHdr; "Purch. Cr. Memo Hdr."."Your Reference")
                    {
                    }
                    column(OrderNoText; OrderNoText)
                    {
                    }
                    column(OrderNo_SalesInvoiceHdr; "Purch. Cr. Memo Hdr."."Vendor Cr. Memo No.")
                    {
                    }
                    ...
                    column(ShipToAddr1; "Purch. Cr. Memo Hdr."."Ship-to Code" + '-' + "Purch. Cr. Memo Hdr."."Ship-to Name")//ShipToAddRec.Code + '-' + ShipToAddr[1])
                    {
                    }
                    column(ShipToAddr2; ShipToAddr[2])
                    {
                    }
                    column(ShipToAddr3; "Purch. Cr. Memo Hdr."."Ship-to Address" + ',' + "Purch. Cr. Memo Hdr."."Ship-to Address 2")
                    {
                    }
                    column(ShipToAddr4; "Purch. Cr. Memo Hdr."."Ship-to City")//ShipToAddr[4])
                    {
                    }
                    column(ShipToAddr5; '-' + "Purch. Cr. Memo Hdr."."Ship-to Post Code")//ShipToAddr[5]"")
                    {
                    }
                    ...
                    column(DocDate_SalesInvHeader; Format("Purch. Cr. Memo Hdr."."Document Date", 0, '<Day,2>-<Month,2>-<Year4>'))
                    {
                    }
                    column(PricesInclVAT_SalesInvHdr; "Purch. Cr. Memo Hdr."."Prices Including VAT")
                    {
                    }

                    column(PricesInclVATYesNo; Format("Purch. Cr. Memo Hdr."."Prices Including VAT"))
                    {
                    }
                    ...
                    column(BillToCustNo_SalesInvHdrCaption; "Purch. Cr. Memo Hdr.".FieldCaption("Buy-from Vendor No."))
                    {
                    }
                    column(PricesInclVAT_SalesInvHdrCaption; "Purch. Cr. Memo Hdr.".FieldCaption("Prices Including VAT"))
                    {
                    }
                    column(ActualWeight; ActualWeight)
                    {
                    }
                    column(NoOfCases; NoOfCases)
                    {
                    }
                    ...
                    dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
                    {
                        ...
                        DataItemLinkReference = "Purch. Cr. Memo Hdr.";
                        DataItemTableView = sorting("Document No.", "Line No.") where("System-Created Entry" = const(false), Type = filter(2));
                        UseTemporary = true;
                        ...
                        column(Desc_SalesInvLine; Description)//Desc)// + ' ' + Description)
                        {
                        }
                        column(Descrip_SalesInvoiceLine; LotNo)
                        {
                        }
                        column(MRP; MRPRate)
                        {
                        ...
                        column(UnitPrice_SalesInvLine; "Direct Unit Cost")
                        {
                            AutoFormatExpression = "Purch. Cr. Memo Line".GetCurrencyCode();
                            AutoFormatType = 2;
                        }
                        ...
                        column(SalesLineType; Format("Purch. Cr. Memo Line".Type))
                        {
                        }
                        ...
                        column(AmtInclVAT_SalesInvLine; "Purch. Cr. Memo Line".Amount)
                        {
                            AutoFormatExpression = "Purch. Cr. Memo Line".GetCurrencyCode();
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATBaseDisc_SalesInvHdr; "Purch. Cr. Memo Hdr."."VAT Base Discount %")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        dataitem("Sales Shipment Buffer"; Integer)
                        {
                            ...
                            begin
                                SalesShipmentBuffer.SetRange("Document No.", "Purch. Cr. Memo Line"."Document No.");
                                SalesShipmentBuffer.SetRange("Line No.", "Purch. Cr. Memo Line"."Line No.");
                        ...
                        begin
                            // Sandeep Code added for description

                            PurchCrMeLine.Reset();
                            PurchCrMeLine.SetRange("Document No.", "Purch. Cr. Memo Hdr."."No.");
                            IF PurchCrMeLine.FindFirst() THEN
                                Desc := PurchCrMeLine.Description;
                            ...
                            if "Purch. Cr. Memo Line".Type = "Purch. Cr. Memo Line".Type::Item then begin
                                Item.Get("Purch. Cr. Memo Line"."No.");
                                // if Item."Kriz SPQ" <> 0 then
                                //     NoofCasesLine := ROUND("Purch. Cr. Memo Line".Quantity / Item."EDC SPQ", 1, '>')
                                // else
                                //     NoofCasesLine := Round("Purch. Cr. Memo Line".Quantity, 1, '>');

                                LotNo := '';
                                ExpiryDate := 0D;
                                MfgDate := 0D;
                                ValueEntry.Reset();
                                ValueEntry.SetRange("Document No.", "Purch. Cr. Memo Line"."Document No.");
                                ValueEntry.SetRange("Document Line No.", "Purch. Cr. Memo Line"."Line No.");
                                ValueEntry.SetRange("Item No.", "Purch. Cr. Memo Line"."No.");
                                IF ValueEntry.FindSet() then
                                    repeat
                                        ItemLedgerEntry.Reset();
                                        ItemLedgerEntry.SetRange("Entry No.", ValueEntry."Item Ledger Entry No.");
                                        IF ItemLedgerEntry.FindSet() then begin
                                            LotNo := ItemLedgerEntry."Lot No.";//+ ',';LotNo+
                                            LotInfo.Reset();
                            ...
                            //if No = 1 then begin
                            GetSalesGSTAmount("Purch. Cr. Memo Hdr.", "Purch. Cr. Memo Line");

                            GetTCSAmt("Purch. Cr. Memo Hdr.", "Purch. Cr. Memo Line");
                            // end;
                ...
                begin
                    ...
                    //   SalesInvCountPrinted.Run("Purch. Cr. Memo Hdr.");
                end;
            ...
            begin
                ...
                ShipToAddRec.Reset();
                ShipToAddRec.SetRange(Code, "Purch. Cr. Memo Hdr."."Ship-to Code");
                if ShipToAddRec.Find('-') then;

                ShipToContactNo := Vendor1."Phone No.";
                ...
                if "Return Order No." = '' then
                    ...
                    OrderNoText := CopyStr(FieldCaption("Return Order No."), 1, 80);
                ...
                FormatAddr.PurchCrMemoBuyFrom(CustAddr, "Purch. Cr. Memo Hdr.");
                if Contact.Get("Purch. Cr. Memo Hdr."."Buy-from Vendor No.") then;
                // if Contact.Get("Purch. Cr. Memo Hdr."."Ship-to Contact") then;
                //  IF FormatAddr.PurchCrMemoShipTo(ShipToAddr, CustAddr, "Purch. Cr. Memo Hdr.") Then;
                ...
                if RecState.get(Vendor."State Code") then
                    SellerState := 'State Name: ' + RecState.Description + ', Code: ' + RecState."State Code (GST Reg. No.)";

                // if RecState.get("GST Bill-to State Code") then
                //     BuyerState := 'State Name: ' + RecState.Description + ', Code: ' + RecState."State Code (GST Reg. No.)";

                // if "Ship-to Code" <> '' then begin
                //     if RecState.get("GST Ship-to State Code") then
                //         ShiptoState := 'State Name: ' + RecState.Description + ', Code: ' + RecState."State Code (GST Reg. No.)";
                ...
                if PayVendor.get("Pay-to Vendor No.") then
                    ShiptoGSTIN := PayVendor."GST Registration No.";
                ...
                // RRLRNo := "Purch. Cr. Memo Hdr."."LR/RR No.";
                //RRLRDate := "Purch. Cr. Memo Hdr."."LR/RR Date";
                //VehicleNo := "Purch. Cr. Memo Hdr."."Vehicle No.";


                EWaybillNo := "Purch. Cr. Memo Hdr."."Eway Bill No.";
                EwayDate := "Purch. Cr. Memo Hdr."."Eway Bill Date";
                ...
                GetLineAmount("Purch. Cr. Memo Hdr.");
                GetSalesGSTAmount("Purch. Cr. Memo Hdr.");
                GetTCSAmt("Purch. Cr. Memo Hdr.");
    ...
    var
        ...
        PurchCrMeLine: Record "Purch. Cr. Memo Line";
        Desc: Text[100];
        ...
        UnitPriceCaptionLbl: Label 'Rate per LTR/KG';
    ...
    begin
        NextEntryNo := 1;
        // if "Purch. Cr. Memo Line"."Shipment No." <> '' then
        //     if SalesShipmentHeader.Get("Purch. Cr. Memo Line"."Shipment No.") then
        //         exit(SalesShipmentHeader."Posting Date");

        if "Purch. Cr. Memo Hdr."."Return Order No." = '' then
            exit("Purch. Cr. Memo Hdr."."Posting Date");
        ...
        if SalesShipmentBuffer.FindFirst() then begin
            ...
            if SalesShipmentBuffer.Quantity <> "Purch. Cr. Memo Line".Quantity then begin
                SalesShipmentBuffer.DeleteAll();
                exit("Purch. Cr. Memo Hdr."."Posting Date");
            end;
        end else
    ...
    procedure GenerateBufferFromValueEntry(SalesInvoiceLine2: Record "Purch. Cr. Memo Line")
    var
        ItemLedgerEntry: Record "Item Ledger Entry";
        ValueEntry: Record "Value Entry";
        Quantity: Decimal;
    ...
    begin
        ...
        ValueEntry.SetRange("Posting Date", "Purch. Cr. Memo Hdr."."Posting Date");
    ...
    procedure GenerateBufferFromShipment(SalesInvoiceLine: Record "Purch. Cr. Memo Line")
    var
        SalesInvoiceHeader: Record "Purch. Cr. Memo Hdr.";
        SalesInvoiceLine2: Record "Purch. Cr. Memo Line";
        SalesShipmentHeader: Record "Purch. Rcpt. Header";
        SalesShipmentLine: Record "Purch. Rcpt. Line";
        Quantity: Decimal;
        TotalQuantity: Decimal;
    begin
        TotalQuantity := 0;
        SalesInvoiceHeader.SetCurrentKey("Return Order No.");
        SalesInvoiceHeader.SetFilter("No.", '..%1', "Purch. Cr. Memo Hdr."."No.");
        SalesInvoiceHeader.SetRange("Return Order No.", "Purch. Cr. Memo Hdr."."Return Order No.");
        ...
        SalesShipmentLine.SetRange("Order No.", "Purch. Cr. Memo Hdr."."Return Order No.");
        ...
        if SalesShipmentLine.FindFirst() then
            repeat
                // if "Purch. Cr. Memo Hdr."."get re" then
    ...
    var
        SalesInvoiceLine: Record "Purch. Cr. Memo Line";
    begin
    ...
    local procedure CheckGSTDoc(SalesLine: Record "Purch. Cr. Memo Line"): Boolean
    var
    ...
    local procedure GetSalesGSTAmount(SalesInvoiceHeader: Record "Purch. Cr. Memo Hdr.";
        SalesInvoiceLine: Record "Purch. Cr. Memo Line")
    var
    ...
    local procedure GetTCSAmt(SalesInvoiceHeader: Record "Purch. Cr. Memo Hdr.";
        SalesInvoiceLine: Record "Purch. Cr. Memo Line")
    var
    ...
    local procedure GetLineAmount(SalesInvoiceHeader: Record "Purch. Cr. Memo Hdr.")
    var
        RecItem: Record item;
        ItemCat: Record "Item Category";
        ItemUOM: Record "Item Unit of Measure";
        SalesInvLine: Record "Purch. Cr. Memo Line";
        Found: Boolean;
        PackUOM: Code[10];
        J: Integer;
    begin
        ...
        if SalesInvLine.FindSet() then
            repeat
                ...
                if SalesInvLine.Type = SalesInvLine.Type::Item then begin
                    ...
                    //     NoOfCases := NoOfCases + ROUND((SalesInvLine.Quantity / RecItem."EDC SPQ"), 1, '>')
                    // else
    ...
    var
        ...
        LotInfo: Record "Lot No. Information";
        SInvLine: Record "Purch. Cr. Memo Line";
        TempSalesShptLine: Record "Return Shipment Line" temporary;
        MfgDate: Date;
        ExpiryDate: Date;
        NextLine: Integer;
        MRPLotInfo: Decimal;
    begin
        "Purch. Cr. Memo Line".DeleteAll();

        SInvLine.Reset();
        SInvLine.SetRange("Document No.", DocumentNo);
        if SInvLine.FindSet() then
            repeat
                "Purch. Cr. Memo Line".Init();
                "Purch. Cr. Memo Line" := SInvLine;
                "Purch. Cr. Memo Line".Insert();

                TempSalesShptLine.DeleteAll();
                if SInvLine.Type = SInvLine.Type::Item then begin
                    SInvLine.GetReturnShptLines(TempSalesShptLine);
                    NextLine := 0;
                            ...
                            if ILE.FindSet() then
                                repeat
                                    ...
                                    if NextLine = 1 then begin
                                        "Purch. Cr. Memo Line"."Description 2" := Ile."Lot No.";
                                        "Purch. Cr. Memo Line"."Tax Group Code" := format(ExpiryDate, 0, '<Closing><Day,2>-<Month,2>-<Year4>');
                                        //"Purch. Cr. Memo Line"."VAT Clause Code" := format(MfgDate, 0, '<Closing><Day,2>-<Month,2>-<Year4>');
                                        //"Purch. Cr. Memo Line".kr := MRPLotInfo;
                                        "Purch. Cr. Memo Line".Modify();
                                    end else begin
                                        "Purch. Cr. Memo Line".Init();
                                        "Purch. Cr. Memo Line"."Document No." := SInvLine."Document No.";
                                        "Purch. Cr. Memo Line"."Line No." := SInvLine."Line No." + NextLine - 1;
                                        "Purch. Cr. Memo Line".Type := "Purch. Cr. Memo Line".Type::" ";
                                        "Purch. Cr. Memo Line"."Description 2" := Ile."Lot No.";
                                        "Purch. Cr. Memo Line"."Tax Group Code" := format(ExpiryDate, 0, '<Closing><Day,2>-<Month,2>-<Year4>');
                                        // "Purch. Cr. Memo Line"."VAT Clause Code" := format(MfgDate, 0, '<Closing><Day,2>-<Month,2>-<Year4>');
                                        // "Purch. Cr. Memo Line"."Kriz MRP" := MRPLotInfo;
                                        "Purch. Cr. Memo Line"."Attached to Line No." := SInvLine."Line No.";
                                        "Purch. Cr. Memo Line".Insert();
                                    end;
                                until ile.Next() = 0;
