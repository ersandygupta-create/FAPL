report 50009 "Kriz Sales Tax Invoice Batch E"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/KrizSalesTaxInvoiceBatchEternity.rdl';
    Caption = 'Eternity Sales Tax Invoice (Batch Detials)';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyAddr4; CompanyInfo.City + '-' + CompanyInfo."Post Code" + ',' + RecState.Description)//CompanyAddr[4])
                    {
                    }
