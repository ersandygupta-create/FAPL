report 50013 "Employee Ledger Dimension"
{
    RDLCLayout = './src/reports/EmployeeLedgerDim.rdl';
    Caption = 'Employee Ledger Report-Dimension';
    DefaultLayout = RDLC;
    PreviewMode = Normal;
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                DataItemLink = "Shortcut Dimension 6 Code" = FIELD("No."),
                               "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                               "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter");
                DataItemTableView = SORTING("Shortcut Dimension 6 Code", "Posting Date")
                                    ORDER(Ascending) where(Reversed = filter(false),
                                     "Shortcut Dimension 6 Code" = FILTER(<> ''));
                ...
                column(CustNo; "Shortcut Dimension 6 Code")
                {
                }
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    begin
                        ...
                        ELSE
                            TempGL.NEXT;
                        DocumentType := Format("G/L Entry"."Document Type");
                        ...
                        IF T480.GET("G/L Entry"."Dimension Set ID", 'BRANCH') then begin
                            T480.CALCFIELDS("Dimension Value Name");
                            AccountNo := T480."Dimension Value Code";
                            AccountName := T480."Dimension Value Name";
                        end;
                ...
                begin
                    ...
                    IF "G/L Entry"."Document Type" = "G/L Entry"."Document Type"::" " then begin

                        LineNarration := "G/L Entry".Description;
                    end;

                    IF "G/L Entry"."Document Type" = "G/L Entry"."Document Type"::Payment then
                        LineNarration := "G/L Entry".Description
                    else
                        LineNarration := "G/L Entry".Description;
                    ...
                    //Pru Raj
                    IF ("G/L Entry"."Document Type" = "G/L Entry"."Document Type"::" ") AND ("G/L Entry"."Debit Amount" <> 0) then
                        DocType := 'Debit Note'
                    ELSE
                        DocType := FORMAT("G/L Entry"."Document Type");

                    TotalDebitAmt += "G/L Entry"."Debit Amount";
                    TotalCredittAmt += "G/L Entry"."Credit Amount";
                end;
            ...
            begin
                ...
                CLEAR(CloseBal);
                T21.RESET();
                T21.SETRANGE(T21."Shortcut Dimension 6 Code", "No.");
    ...
    var
        ...
        ReportCap: Label 'Employee Ledger ';
        CloseBal: Decimal;
        LoanTenure: Integer;
